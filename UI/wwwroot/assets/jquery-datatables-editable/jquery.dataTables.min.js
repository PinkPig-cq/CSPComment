...
oPaginate:{sFirst:"首页",尾页",sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"表中暂无数据!",sInfo:"显示从 _START_ 到 _END_ 共 _TOTAL_ 条",sInfoEmpty:"显示从 0 到 0 共 0 条",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"显示 _MENU_ 行",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"查询:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},
